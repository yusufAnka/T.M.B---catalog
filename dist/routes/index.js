...
const { getProducts, getProductById, addNewProduct, updateProduct, deleteProduct, purchaseProducts, addToCart, searchProducts, } = require("../controllers/productsControl");
...
router.put("/update/:id", adminProtect, (req, res) => {
